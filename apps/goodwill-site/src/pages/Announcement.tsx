  ...
  const announcements = [
    ...
    },
    {
      ...
      content: "GOODWILL(KE) Inc.에서 **디자인으로 브랜드의 가치를 새롭게 정의할 인재**를 찾습니다! 🎭  \n" +
          ...
          "## 2-1. 지원대상  \n" +
          "\n" +
          "1. **국적**: 대한민국 국적자 - 복수국적자는 외국국적불행사서약 시 지원 가능. 관련 서류는 국적법에 따라 관계 기관에 제출하여 처리 완료되어야 함 (’25년 04월 30일까지)  \n" +
          "2. **연령**: 2007년 12월 31일 이후 ~ 2009년 12월 31일 이전 출생자  \n" +
          ...
          "4. **GOODWILL(KE) Inc. Design 창직군 신규입사 선발과정에서 탈락한 경우 재지원 가능**  \n" +
          "\n" +
          "---  \n" +
          "\n" +
          "# 3. 선발일정  \n" +
          ...
          "\n" +
          "GOODWILL(KE) Inc.는 효과적인 인재 영입을 위하여 아래의 우대사항을 충족하는 경우 ‘리틀 도널드 노먼’ 칭호를 부여하고 선발 절차를 간소화할 수 있습니다.  \n" +
          "\n" +
          "1. GOODWILL(KE) Inc. 사칙에 따라 CEO 혹은 이에 준하는 GOODWILL C-Level의 경영진이 인정하는 ‘리틀 도널드 노먼’ 칭호를 받은 자.  \n" +
          "2. 중·고등학교 재학 중 ‘장관상급 이상’ 혹은 ‘국제 대회’ 수상 경력이 있으며, CEO 혹은 GOODWILL C-Level의 경영진이 인정하는 ‘리틀 도널드 노먼’ 칭호를 받은 자.  \n" +
          "\n" +
          "---  \n" +
          "\n" +
          "# 5. 접수 안내  \n" +
