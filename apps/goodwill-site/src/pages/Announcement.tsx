  ...
  const announcements = [
    {
      ...
      title: "점검 안내",
      content:
        "안녕하세요, 굿윌입니다. 서버 점검으로 인해 아래의 시간 동안 서비스가 일시 중단됩니다. 서버 점검 시간: 2022년 7월 21일(목) 00:00 ~ 06:00 긴급 문의는 [고객 지원 이메일 또는 연락처] 로 부탁드립니다. 이용에 불편을 드려 죄송합니다. 더욱 안정적인 서비스 제공을 위해 최선을 다하겠습니다. 감사합니다.",
      date: "2024년 03월 01일",
      views: "100",
    },
    {
