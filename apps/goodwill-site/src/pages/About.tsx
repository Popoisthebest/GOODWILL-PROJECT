      ...
      <DefaultLayout>
        <div css={aboutDiv}>
          ...
          <div css={subText}>
            ...
            2015년 첫 출범 이후 '더 나은 세상, 더 나은 내일(Better World,
            Brighter Tomorrow)'라는 슬로건 아래 꾸준한 발전을 추구하며, 사람과
            사회를 생각하는 국내 고등학생 기업체로서 자리매김 하고 있습니다.
          </div>
          ...
          <div css={subText}>
            ...
            로보틱스, 메타버스 등 미래 기술에 대한 지속적인 연구개발과 협력을
            통해 기술 플랫폼의 변화와 혁신을 추구하며 모두가 성장할 수 있도록
            노력하고 있습니다.
          </div>
        </div>
      </DefaultLayout>
